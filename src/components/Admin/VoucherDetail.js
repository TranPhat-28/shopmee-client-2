    ...
    return (
        <div className="mt-4">
            ...
            {detailData && <form onSubmit={deleteVoucher}>
                ...
                <input className="form-control mb-2" type="text"
                    value={voucherCode} onChange={(e) => setVoucherCode(e.target.value)} disabled></input>

                <label className="form-label mb-0">Expiration date</label>
                <input className="form-control mb-2" type="text"
                    value={exp} onChange={(e) => setExp(e.target.value)} disabled></input>

                <label className="form-label mb-0">Discount percent</label>
                <input className="form-control mb-2" type="text"
                    value={percent} onChange={(e) => setPercent(e.target.value)} disabled></input>

                <label className="form-label mb-0">Summary</label>
                <input className="form-control mb-2" type="text"
                    value={sum} onChange={(e) => setSum(e.target.value)} disabled></input>

                <label className="form-label mb-0">Description</label>
                <textarea rows="3" className="form-control mb-2" type="text"
                    value={desc} onChange={(e) => setDesc(e.target.value)} disabled></textarea>
